...
def index(request):
    ...
    books_with_of = Book.objects.filter(title__icontains='of').count()
    ...
    return render(
        ...
        context={'num_books': num_books, 'num_instances': num_instances,
                 ...
                 'num_genres': num_genres, 'books_with_of': books_with_of, 'num_visits': num_visits},
    )
...
class LoanedBooksListView(LoginRequiredMixin, PermissionRequiredMixin, generic.ListView):
    """
    Generic class-based view listing books loaned by customers.
    """
    model = BookInstance
